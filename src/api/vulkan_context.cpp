...
namespace Chotra_RT {
    ...
    VulkanContext& VulkanContext::GetInstance(GLFWwindow* glfw_window) {

        static VulkanContext instance(glfw_window);
        return instance;
    }

    VulkanContext::VulkanContext(GLFWwindow* glfw_window) {
    ...
    void VulkanContext::CreateInstance() {
        ...
        appInfo.pApplicationName = "Chotra_RT";
